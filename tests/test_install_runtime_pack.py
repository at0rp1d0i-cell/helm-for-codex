...
def test_installer_populates_runtime_dirs(tmp_path: Path) -> None:
    ...
    assert (target / ".codex" / "roles" / "design-reviewer.toml").exists()
    ...
    assert (target / ".agents" / "skills" / "design-review" / "SKILL.md").exists()
    assert (target / ".agents" / "skills" / "design-review" / "agents" / "openai.yaml").exists()
    ...
    assert (target / "ops" / "templates" / "office-hours-brief.md").exists()
    assert (target / "ops" / "templates" / "discovery-gate.md").exists()
