...
def test_required_top_level_paths_exist() -> None:
    required = [
        ...
        ROOT / "plugins" / "codex-ai-team" / "assets" / "runtime-pack",
...
def test_repo_check_covers_minimum_team_shape() -> None:
    ...
    expected = [
        ...
        "plugins/codex-ai-team/.codex-plugin/plugin.json",
        "plugins/codex-ai-team/scripts/bootstrap_repo.py",
        "plugins/codex-ai-team/skills/team-runtime-bootstrap/SKILL.md",
        "plugins/codex-ai-team/skills/team-runtime-bootstrap/agents/openai.yaml",
        "plugins/codex-ai-team/assets/runtime-pack/AGENTS.md",
        "plugins/codex-ai-team/assets/runtime-pack/.codex/config.toml",
        "plugins/codex-ai-team/assets/runtime-pack/scripts/install_runtime_pack.py",
        "plugins/codex-ai-team/assets/runtime-pack/scripts/runtime_pack_manifest.py",
        "plugins/codex-ai-team/assets/runtime-pack/skills/team-lead/SKILL.md",
