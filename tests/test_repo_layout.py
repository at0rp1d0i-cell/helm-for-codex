...
def test_required_top_level_paths_exist() -> None:
    required = [
        ...
        ROOT / "plugins" / "helm4codex" / ".codex-plugin" / "plugin.json",
        ROOT / "plugins" / "helm4codex" / "scripts" / "bootstrap_repo.py",
        ROOT / "plugins" / "helm4codex" / "skills" / "team-runtime-bootstrap" / "SKILL.md",
        ROOT / "plugins" / "helm4codex" / "assets" / "runtime-pack",
        ROOT / "skills" / "team-lead",
        ROOT / "skills" / "researcher",
        ROOT / "skills" / "design-review",
        ...
        ROOT / ".agents" / "skills" / "researcher",
        ROOT / ".agents" / "skills" / "product-discovery",
        ROOT / ".agents" / "skills" / "design-review",
...
def test_repo_check_covers_minimum_team_shape() -> None:
    ...
    expected = [
        ...
        "plugins/helm4codex/.codex-plugin/plugin.json",
        "plugins/helm4codex/scripts/bootstrap_repo.py",
        "plugins/helm4codex/skills/team-runtime-bootstrap/SKILL.md",
        "plugins/helm4codex/skills/team-runtime-bootstrap/agents/openai.yaml",
        "plugins/helm4codex/assets/runtime-pack/AGENTS.md",
        "plugins/helm4codex/assets/runtime-pack/.codex/config.toml",
        "plugins/helm4codex/assets/runtime-pack/scripts/install_runtime_pack.py",
        "plugins/helm4codex/assets/runtime-pack/scripts/check_installed_runtime.py",
        "plugins/helm4codex/assets/runtime-pack/scripts/runtime_pack_manifest.py",
        "plugins/helm4codex/assets/runtime-pack/scripts/upgrade_runtime_pack.py",
        "plugins/helm4codex/assets/runtime-pack/scripts/runtime_pack_manifest.py",
        "plugins/helm4codex/assets/runtime-pack/skills/team-lead/SKILL.md",
        ...
        ".codex/roles/release-manager.toml",
        ...
        ".agents/skills/researcher/agents/openai.yaml",
        ".agents/skills/product-discovery/SKILL.md",
        ".agents/skills/design-review/SKILL.md",
        ".agents/skills/design-review/agents/openai.yaml",
        ...
        "ops/templates/office-hours-brief.md",
        "ops/templates/research-brief.md",
        "ops/templates/discovery-gate.md",
        ...
        "scripts/export_plugin_runtime.py",
